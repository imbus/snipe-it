    ...
    public function testPurchaseDateQueryEnd()
    {
        ...
        $filter = [
            [
                'field' => 'purchase_date',
                'value' => [
                    'endDate' => Carbon::now()->addWeeks(7)->format('Y-m-d'),
                ],
                'operator' => 'contains',
                'logic' => 'AND',
            ]
    ...
    public function testEolDateQueryStart()
    {
        ...
        $filter = [
            [
                ...
                'value' => [
                    'startDate' => Carbon::now()->addMonths(16)->format('Y-m-d'),
                ],
                'operator' => 'contains',
                'logic' => 'AND',
            ]
    ...
    public function testEolDateQueryEnd()
    {
        ...
        $filter = [
            [
                'field' => 'asset_eol_date',
                'value' => [
                    'endDate' => Carbon::now()->addMonths(14)->format('Y-m-d'),
                ],
                'operator' => 'contains',
                'logic' => 'AND',
            ]
    ...
    public function testEolDateQueryRange()
    {
        ...
        $filter = [
            [
                'field' => 'asset_eol_date',
                'value' => [
                    'startDate' => Carbon::now()->addMonths(24)->format('Y-m-d'),
                    'endDate' => Carbon::now()->addMonths(55)->format('Y-m-d'),
                ],
                'operator' => 'contains',
                'logic' => 'AND',
            ]
