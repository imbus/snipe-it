            ...
            <div class="tab-content">
                            ...
                            <div class="col-md-3 col-xs-12 col-sm-push-9 info-stack">
                                                ...
                                                <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                                    <span class="tooltip-wrapper" {!! (!$asset->model ? ' data-tooltip="true" title="' . trans('admin/hardware/general.model_invalid_fix') . '"' : '') !!}>
                                                        <a href="{{ route('hardware.checkout.create', $asset->id)  }}"
                                                            class="btn btn-sm bg-maroon btn-social btn-block hidden-print{{ (!$asset->model ? ' disabled' : '') }}">
                                        ...
                                        <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                            <span class="tooltip-wrapper" {!! (!$asset->model ? ' data-tooltip="true" title="' . trans('admin/hardware/general.model_invalid_fix') . '"' : '') !!}>
                                                <a href="{{ route('asset.audit.create', $asset->id)  }}"
                                                    class="btn btn-sm btn-primary btn-block btn-social hidden-print{{ (!$asset->model ? ' disabled' : '') }}">
                                                    <x-icon type="audit" />
                                                    {{ trans('general.audit') }}
                                                </a>
                                            </span>
                                ...
                                @can('create', $asset)
                                    <div class="col-md-12 hidden-print" style="padding-top: 5px;">
                                        <a href="{{ route('clone/hardware', $asset->id) }}"
                                            class="btn btn-sm btn-info btn-block btn-social hidden-print">
                                            <x-icon type="clone" />
                                ...
                                @can('delete', $asset)
                                    <div class="col-md-12 hidden-print" style="padding-top: 30px; padding-bottom: 30px;">
                                        ...
                                        @if ($asset->deleted_at == '')
                                            <button class="btn btn-sm btn-block btn-danger btn-social delete-asset"
                                ...
                                @if (($snipeSettings->qr_code == '1') || $snipeSettings->label2_2d_type != 'none')
                                    <div class="col-md-12 text-center" style="padding-top: 15px;">
                                        <img src="{{ config('app.url') }}/hardware/{{ $asset->id }}/qr_code"
                                            class="img-thumbnail" style="height: 150px; width: 150px; margin-right: 10px;"
                                            ...
                                            <div class="row">
                                                ...
                                                <div
                                                    ...
                                                    @if (!empty($asset->{$field->db_column_name()}))
                                                        ...
                                                        it results in extra spaces being added onto the end of the coipied value
                                                        --}}
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-9">
                                                ...
                                                @if ($asset->eol_explicit == '1')
                                                    <span data-tooltip="true" data-placement="top" data-title="Explicit EOL"
                                                        title="Explicit EOL">
                            ...
                            <table class="table">
                                <thead>
                                    <tr>
                                        ...
                                        <th><span class="line"></span>{{ trans('admin/licenses/form.license_key') }}
                                        </th>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    @can('viewKeys', $seat->license)
                                                        <code
                                                            class="single-line"><span class="js-copy-link" data-clipboard-target=".js-copy-key-{{ $seat->id }}" aria-hidden="true" data-tooltip="true" data-placement="top" title="{{ trans('general.copy_to_clipboard') }}"><span class="js-copy-key-{{ $seat->id }}">{{ $seat->license->serial }}</span></span></code>
                                                    @else
                                                        ------------
                                                    @endcan
                                                </td>
                ...
                <div class="tab-pane" id="accessories_assigned">
                    ...
                    <div class="table table-responsive">
                        ...
                        <table data-columns="{{ \App\Presenters\AssetPresenter::assignedAccessoriesDataTableLayout() }}"
                    ...
                    <div class="row{{($asset->maintenances->count() > 0) ? '' : ' hidden-print'}}">
                        <div class="col-md-12">
                            ...
                            <table data-columns="{{ \App\Presenters\MaintenancesPresenter::dataTableLayout() }}"
                                ...
                                data-side-pagination="server" data-toolbar="#maintenance-toolbar" data-export-options='{
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table class="table table-striped snipe-table" id="assetAuditHistory"
                                data-id-table="assetAuditHistory" data-side-pagination="server" data-sort-order="desc"
                                data-sort-name="created_at" data-export-options='{
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th class="col-sm-2" data-field="file" data-sortable="true" data-visible="false"
                                            data-formatter="fileNameFormatter">{{ trans('general.file_name') }}
                                        </th>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <table data-columns="{{ \App\Presenters\HistoryPresenter::dataTableLayout() }}"
                                class="table table-striped snipe-table" id="assetHistory" data-id-table="assetHistory"
