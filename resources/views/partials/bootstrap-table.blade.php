...
<script nonce="{{ csrf_token() }}">
    $(function () {
        ...
        // cleanup rules. innerHtml must already be XSS-safe â€” callers HTML-
        ...
        var storeAdvancedSearchOperator = function (operator) {
            ...
            // `<textarea>` innerHTML is RCDATA â€” the parser decodes entity
            // references like `&lt;` but does not interpret `<tag>` as an
            // element. Contrast with the naive `$('<div/>').html(value).text()`
            // pattern, which parses value as HTML into a detached div â€” an
            ...
            BootstrapTable.prototype.createToolbarForm = function () {
                ...
                for (var columnIndex = 0; columnIndex < this.columns.length; columnIndex++) {
                    ...
                    if (!column.checkbox && column.visible && column.searchable) {
                        ...
                        // â€” the label, name, and placeholder all get untrusted content.
        ...
        $('.snipe-table').bootstrapTable('destroy').each(function () {
            ...
            // right after jspdf.umd.min.js â€” see webpack.mix.js). Referencing
            ...
            // tableWidth: 'wrap',
            // âš ï¸ SECURITY: DO NOT change the wrapping of `.text()` inside
            ...
            //   3. Export â†’ CSV (or PDF): alert(1) fires because tableExport
            ...
            export_options['onCellHtmlData'] = function (cell, rowIndex, colIndex, htmlData) {
                if (cell.is('th')) {
                    // âš ï¸ MUST stay wrapped in htmlEncodeForExport(). See block above.
            ...
            // so `this` inside them is the options object, not the DOM element â€”
            ...
            $(this).bootstrapTable({
                ...
                onPostHeader: function () {
                    // Initial header render (and any layout re-init) â€” reflect
            ...
            //    and rendering pills â€” it never refetches, and never fires the
            ...
            //     addrbar â†’ updateHistoryState path, which we've also patched.
            //
            ...
            if (bootstrapTableInstance && data_with_default('advanced-search-deeplink', false)) {
                ...
                if (typeof bootstrapTableInstance.applyAdvancedSearch === 'function') {
                    ...
                    bootstrapTableInstance.applyAdvancedSearch = function () {
                        ...
                        if (this.options.sidePagination === 'server') {
                            ...
                            // resetSearch()/onSearch() â€” that path would fire a
                ...
                //     onSearch â†’ initSearch â†’ server refetch, so the AJAX that
                ...
                if (Object.keys(initialFilters).length > 0) {
                    ...
                    // Refetch with the seeded filter. onLoadSuccess â†’ patched
                    // updateHistoryState â†’ URL is re-emitted with filter[...] intact.
    ...
    $('.snipe-table').on('post-body.bs.table', function () {
        ...
        if ($paginationDetail.length && !document.getElementById(rawCountId)) {
            ...
            $selectedCount.append(document.createTextNode('â€” '));
...
=======
        'predefined-filters'
>>>>>>> 439d6ed01c (fixed predefined-filter index)
    ];
    ...
    // Renders a single company tag. `isInherited` is decided by the caller â€”
    ...
    function isCompanyTagInherited(tagId, rowCompanyIds) {
        ...
        // Row is direct (some company on the row matches viewing) â€” nothing
   ...
   function imageFormatter(value, row) {
    ...
    function updateTopScrollbar(root) {
        ...
        // primary .fixed-table-body's actual scroll width â€” visible on
        ...
        $targets.each(function () {
            ...
            // column widths â€” .remove()-ing the scrollbar during that
